    ...
    <>
      ...
      >
        ...
        >
          <li>
            <button
              data-modal-target={`modal-${postId}`}
              data-modal-toggle={`modal-${postId}`}
              onClick={() => {
      ...
      >
        ...
        >
          <div className="flex justify-between items-center  gap-5 ">
            ...
            />
            <label htmlFor="image">
              <i className="fa-regular fa-image cursor-pointer text-3xl text-gray-700"></i>
            </label>
